        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center">
                ...
                <nav class="hidden md:flex space-x-6 mr-6">
                    ...
                    <a href="{{ route('posts.index') }}" class="nav-link hover:text-yellow-300">Berita</a>
                    <a href="{{ route('categories.index') }}" class="nav-link hover:text-yellow-300 font-bold border-b-2 border-yellow-300">Kategori</a>
