            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('posts.index') }}" class="px-4 py-2 rounded-full {{ !request('category') ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                            Semua
                        </a>
                ...
                @forelse($posts as $post)
                    <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <div class="p-6">
                            ...
                            <a href="{{ route('posts.show', $post) }}" class="text-purple-600 hover:text-purple-800 font-semibold flex items-center">
